...
import { uploadAvatarAPI, uploadCloudAPI } from "../utils/fetchFromAPI";
        ...
        <div className="row">
          <div className="col-2">
            ...
            onChange={() => {
              ...
              //   listFormData.append("avatar", files[index])
              // }
              ...
              // formData.append("upload_preset", "qyrfb1fr")
              ...
              uploadAvatarAPI(formData).then(result => {
                console.log(result)
                setAvatar(`http://localhost:8080/${result.filename}`)
              })
            }}
            />
